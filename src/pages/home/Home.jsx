...
const Home = () => {
  ...
  return (
    <div>
      ...
      {/* Latest News */}
      <h1 className="container mx-auto w-[90%] mt-14 -mb-6 font-semibold text-3xl">{t("Header.actualNews")}</h1>
      ...
      <hr/>
        <div>
          J-08 Asim Abbos, Muhammad Afzal, Jamil Husayn, Taqdir Ali, Hofiz Sayid Muhammad Bilol, Sungyoung Li va Seokxi Jeon, " Avtomatik izohlashni qo'llab-quvvatlash uchun leksik semantika bilan klinik kontseptsiyani olish ", Xalqaro atrof-muhitni o'rganish va jamoat salomatligi jurnali (SCIE, IF: 3.390) ), 18-jild, №20, 1-6-betlar, 2021 yil 
        </div>
      </div>
      {/* Image Gallary */}
<form className="border-1">
  <textarea name="" id="" cols="30" rows="10">
      ...
      {/* Video News */}
      <h1 className="container mx-auto w-[90%] mt-14 -mb-6 font-semibold text-3xl">Virtual Qabulxona</h1>
  ...
  <label className="block ">
    ...
    <input type="text" required  className="required  mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1"  placeholder="F.I.O."/>
  </label>
  ...
  <label className="block  w-1/2 ">
    ...
    <input type="number"  required  className="  mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1"  placeholder="+(998) --- -- -- "/>
  </label>

  <label className="block  w-1/2">
    <span className ="block  text-slate-900">Elektron pochta</span>

    <input type="email"  required   className="  mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1"  placeholder="Elektron pochta"/>
  </label>
  </div>

  <label className="block ">
  <span className ="block  mt-5 text-slate-900">Murojaat turi</span>
    <select name="" id=""  required   className="mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1">
    ...
    <textarea cols="30"  required   rows="10"  className="  mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1"  placeholder="F.I.O."></textarea>
  </label>

  <label className="block ">
    <span className ="block mt-5 text-slate-900">Username</span>

    <input type="file"  className="  mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1"  placeholder="F.I.O."/>
  </label>
